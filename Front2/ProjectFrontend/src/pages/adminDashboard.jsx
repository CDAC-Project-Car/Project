...
import DeleteUser from '../components/Admin/DeleteUser';
import DeleteCar from '../components/Admin/DeleteCar';
import FetchAllUsers from '../components/Admin/FetchAllUsers';
import FetchUserDetails from '../components/Admin/FetchUserDetails';
import './AdminDashboard.css'; // Ensure correct path to your CSS file
import AdminNavbar from '../components/Admin/AdminNavbar';
import 'bootstrap/dist/css/bootstrap.min.css';
                ...
                <Row>
                    <Col sm={3} className="sidebar">
                        <Nav variant="pills" className="flex-column">
                            ...
                            <Nav.Item>
                                <Nav.Link eventKey="fetchAllUsers">Fetch All Users</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="fetchUserDetails">Fetch User Details</Nav.Link>
                            </Nav.Item>
                        </Nav>
                    </Col>
                    <Col sm={9}>
                        <Tab.Content className="tab-content-area">
                            ...
                            <Tab.Pane eventKey="fetchAllUsers">
                                <FetchAllUsers />
                            </Tab.Pane>
                            <Tab.Pane eventKey="fetchUserDetails">
                                <FetchUserDetails />
                            </Tab.Pane>
                        </Tab.Content>
                    </Col>
