...
@Configuration // to tell SC , this is com.sunbeam.config class containing @Bean methods
...
// .antMatchers(HttpMethod.OPTIONS).permitAll().antMatchers("/players/**").hasRole("PLAYER")
.antMatchers("/admin/**","/**","/v*/api-doc*/**", "/swagger-ui/**").hasRole("ADMIN")
.antMatchers("/users/", "/cars/", "/cart/","/**","/v*/api-doc*/**", "/swagger-ui/**").permitAll().anyRequest().authenticated().and()
